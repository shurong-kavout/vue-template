...
export default {
  ...
  watch: {
    lookback: {
      immediate: true,
      handler(val) { this.selectorStore.multifactor_sequential.lookback = val }
    },
    chosen_metric: {
      immediate: true,
      handler(val) { this.selectorStore.multifactor_sequential.chosen_metric = val }
    }
  },
  methods: {
  }
